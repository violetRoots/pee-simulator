...
namespace UnityFx.Outline
{
	public static class OutlineEditorUtility
	{
		...
		public static readonly GUIContent RenderEventContent = new GUIContent("Render Event", "Outline render event. Multiple values can be selected at the same time.");
